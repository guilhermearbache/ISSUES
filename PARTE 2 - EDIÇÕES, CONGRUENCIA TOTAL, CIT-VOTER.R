...
setwd("C:/Users/user/Google Drive/TESE - Congruência/LASPP")
...
## Filtrando só 2010 e 2012, anos a serem usados no LAPOP, e tirando "ros7" que não tem em nenhum banco a ser utilizado
#por enquanto (deve ter em 2014 ou em alguns poucos países que não estão nessa seleção, algo assim).
## Também vou tirar algumas variáveis que eu tinha selecionado - socioeconômicas, issue_priority, teste de conhecimentos)
